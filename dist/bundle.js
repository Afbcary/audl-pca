...
},{"ml-array-rescale":5}],7:[function(require,module,exports){
'use strict';
...
class PCA {
  constructor(dataset, options = {}) {
    ...
    if (useCovarianceMatrix) {
      ...
      this._adjust(dataset);
      var svd = new mlMatrix.SVD(dataset, {
...
},{"ml-matrix":6}],8:[function(require,module,exports){
//! moment.js
...
function generateBarGraph(canvasName, sortedData, labelText, title) {
    ...
    const formattedValues = sortedData.map(d => d < 1 ? d.toExponential(3).toString() : d.toPrecision(3));
    const labels = [];
